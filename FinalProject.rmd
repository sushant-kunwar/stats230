...
States2015$SCORE_ASIAN <- replaceNA(States2015$SCORE_ASIAN)
States2015$SCORE_NATIVE_AM <- replaceNA(States2015$SCORE_NATIVE_AM)
States2015$SCORE_HISPANIC_LATINO <- replaceNA(States2015$SCORE_HISPANIC_LATINO)
States2015$SCORE_BLACK <- replaceNA(States2015$SCORE_BLACK)
States2015$SCORE_WHITE <- replaceNA(States2015$SCORE_WHITE)
States2015$SCORE_HAWAIIAN_PI <- replaceNA(States2015$SCORE_HAWAIIAN_PI)
States2015$SCORE_MULTIPLE_RACES <- replaceNA(States2015$SCORE_MULTIPLE_RACES)
