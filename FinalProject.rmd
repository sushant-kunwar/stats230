...
#Removing the PRIMARY_KEY COLUMN as it'll be redundant/confusing later
States1992 <- States1992[ ,-1]
View(States1992)

#adding state Abbreviation(work in progress)
States1992$STATE_ABB <- state.abb[match(States1992$STATE, state.name)]
View(States1992)
States1992$STATE_ABB
?state.abb
