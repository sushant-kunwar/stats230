...
PLOTS AND MAYBE IF THINGS WERENT STASTISTICALLY DIFFERENT THEN THEY ENDED UP BEING

```{r}
#Scatter plot comparing total instruction expenditure and avg math score (1992 and 2015)
plot(States1992$AVG_MATH ~ States1992$INSTRUCTION_EXPENDITURE, main = "Average Math Score", xlab = "Plot of Total Expenditure vs Avg Math Score in 1992", ylab = "Total Expenditure", pch = 19)

plot(States2015$AVG_MATH ~ States2015$INSTRUCTION_EXPENDITURE, main = "Average Math Score", xlab = "Plot of Total Expenditure vs Avg Math Score in 2015", ylab = "Total Expenditure", pch = 19)
```
```{r}
#Scatter plot comparing proportional expenditure and avg math score (1992 and 2015)
plot(States1992$AVG_MATH ~ States1992$PROP_INSTRUCTION_EXPENDITURE, main = "Average Math Score", xlab = "Plot of Total Expenditure vs Avg Math Score in 1992", ylab = "Total Expenditure", pch = 19)

plot(States2015$AVG_MATH ~ States2015$PROP_INSTRUCTION_EXPENDITURE, main = "Average Math Score", xlab = "Plot of Total Expenditure vs Avg Math Score in 2015", ylab = "Total Expenditure", pch = 19)
```
...
```
Mention which state is the crazy outlier
