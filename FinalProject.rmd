...
PROP_INSTR_EXP: proportion instruction expenditure

AVG_MATH: Average math score of eighth grade students

AVG_MATH_M: Average math score of eighth grade students that are classified as "male"

AVG_MATH_F: Average math score of eighth grade students that are classified as "female"

MATH_GENDER_DIF: CREATE THIS ONE (just G08_A_M_MATHEMATICS - G08_A_F_MATHEMATICS)

SCORE_ASIAN: Average math score of eighth grade students that are classified as "Asian"

SCORE_NATIVE_AM: Average math score of eighth grade students that are classified as "Native American"

SCORE_HISPANIC_LATINO: Average math score of eighth grade students that are classified as "Hispanic/Latino"

SCORE_BLACK: Average math score of eighth grade students that are classified as "Black"

SCORE_WHITE: Average math score of eighth grade students that are classified as "White"

SCORE_HAWAIIAN_PI: Average math score of eighth grade students that are classified as "Hawaiian Native/Pacific Islander"

MULTIPLE_RACES: Average math score of eighth grade students that are classified as "Two or more races"
...
```{r}
States <- read.csv("/Users/poedoub/Desktop/states_all_extended.csv")
## View(States)
...
*ANCOVA TESTING*
```{r}
replaceNA_with_median <- function(x) {
  replace(x, is.na(x), median(x, na.rm = TRUE))
}

# Apply the function to each column that will be used in the ANOVA
States2015$SCORE_ASIAN <- replaceNA_with_median(States2015$SCORE_ASIAN)
States2015$SCORE_NATIVE_AM <- replaceNA_with_median(States2015$SCORE_NATIVE_AM)
States2015$SCORE_HISPANIC_LATINO <- replaceNA_with_median(States2015$SCORE_HISPANIC_LATINO)
States2015$SCORE_BLACK <- replaceNA_with_median(States2015$SCORE_BLACK)
States2015$SCORE_WHITE <- replaceNA_with_median(States2015$SCORE_WHITE)
States2015$SCORE_HAWAIIAN_PI <- replaceNA_with_median(States2015$SCORE_HAWAIIAN_PI)
States2015$SCORE_MULTIPLE_RACES <- replaceNA_with_median(States2015$SCORE_MULTIPLE_RACES)
States2015$AVG_MATH <- replaceNA_with_median(States2015$AVG_MATH)

# Run the ANOVA
AOV <- aov(AVG_MATH ~ SCORE_ASIAN + SCORE_NATIVE_AM + SCORE_HISPANIC_LATINO + SCORE_BLACK + SCORE_WHITE + SCORE_HAWAIIAN_PI + SCORE_MULTIPLE_RACES, data = States2015)
summary(AOV)
```
